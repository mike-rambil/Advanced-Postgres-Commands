...
1. [Common Table Expressions (CTEs)](./Lesson-1.md#common-table-expressions-ctes)  
   - [Syntax](./Lesson-1.md#syntax)  
   - [Example](./Lesson-1.md#example)  
   - [Recursive CTE](./Lesson-1.md#recursive-cte)  

2. [Subtables (Subqueries in FROM Clause)](./Lesson-1.md#subtables-subqueries-in-from-clause)  
   - [Syntax](./Lesson-1.md#syntax-1)  
   - [Example](./Lesson-1.md#example-1)  

3. [Transactions](./Lesson-1.md#transactions)  
   - [Syntax](./Lesson-1.md#syntax-2)  
   - [Example](./Lesson-1.md#example-2)  
   - [Rollback](./Lesson-1.md#rollback)  
